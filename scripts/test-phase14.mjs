...
if (!WORKER_ONLY) {
  ...
  await test("v9 remains lossless through v15 with empty review, recovery and group maps", () => {
  ...
  await test("v1-v15 remain accepted backup versions", () => {
